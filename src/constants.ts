...
// Creator fee (in %)
export const PLATFORM_CREATOR_FEE = 0.0 // 1% !!max 7%!!

export const MULTIPLAYER_FEE = 0.0 // 1% 

// Jackpot fee (in %)
export const PLATFORM_JACKPOT_FEE = 0.0 // 0.1%,  not jackpot game specific, but platform wide

// Referral fee (in %)
export const PLATFORM_REFERRAL_FEE = 0.00 // 0.25%
