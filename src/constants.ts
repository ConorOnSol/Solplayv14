...
export const RPC_ENDPOINT = import.meta.env.VITE_RPC_ENDPOINT ?? 'https://mainnet.helius-rpc.com/?api-key=283fac28-5a60-4a8a-a3f4-cbc72f8c9086'

// Solana address that will receive fees when somebody plays on this platform
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  '72id7prMoasBwKQ9o7bbUJs831nfp9pvBa1SeUKrq5Rc',
)

// Gamba explorer URL - Appears in RecentPlays
export const EXPLORER_URL = 'https://explorer.gamba.so/platform/72id7prMoasBwKQ9o7bbUJs831nfp9pvBa1SeUKrq5Rc'
...
// Jackpot fee (in %)
export const PLATFORM_JACKPOT_FEE = 0.05 // 0.1%,  not jackpot game specific, but platform wide
...
export const POOLS = [
  ...
  //private pool example (mint + authority) this is used for your own token
