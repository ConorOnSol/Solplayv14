...
export const MULTIPLAYER_FEE = 0.02 // 1% 

// Jackpot fee (in %)
export const PLATFORM_JACKPOT_FEE = 0.002 // 0.1%,  not jackpot game specific, but platform wide

// Referral fee (in %)
export const PLATFORM_REFERRAL_FEE = 0.003 // 0.25%
